...
public class Exercicio01Resposta {
    ...
    public static void main(String args[]){
        ...
        System.out.println("A quantidade de cores que o arco-íris: " + coresArcoIris.size());
        ...
        Set<String> coresArcoIris3 = new LinkedHashSet<>(Arrays.asList("violeta", "anil", "verde", "amarelo", "laranja", "vermelho"));
